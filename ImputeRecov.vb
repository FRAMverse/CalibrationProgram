                    ...
                    For STk = MinStk To NumStk
                        For Age = 2 To MaxAge
                            If CWTAll(STk, Age, Fish, TStep) > 0 Then
                                ...
                                AnnualCatch(Fish, TStep) = AnnualCatch(Fish, TStep) + CWTAll(STk, Age, Fish, TStep)
                    ...
                    Select Case CatchFlag(Fish, TStep) 'located in cal file to the right of base period fishery catches or in BasePeriodCatch table of Calibration Support db
                        ...
                        Case 1
                            ...
                            For STk = MinStk To NumStk
                                For Age = 2 To MaxAge
                                    If CWTAll(STk, Age, Fish, TStep) > 0 Then
                                        TotExpCWTAll(STk, Age, Fish, TStep) = CWTAll(STk, Age, Fish, TStep) * RecAdjFactor(Fish, TStep)
                                    End If
                                Next Age
                            Next STk
                            'Next TStep
